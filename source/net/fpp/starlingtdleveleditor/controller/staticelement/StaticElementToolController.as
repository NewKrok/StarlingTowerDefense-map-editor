...
package net.fpp.starlingtdleveleditor.controller.staticelement
{
	...
	public class StaticElementToolController extends AToolController
	{
		...
		private var _draggedStaticElementView:StaticElementView;
		...
		public function StaticElementToolController()
		{
			...
			this._staticElementToolMenu = new StaticElementToolMenu();
		}
		...
		override public function deactivate():void
		{
			...
			{
				this._staticElementContainer.removeChild( this._staticElementPreview );
			}
...
trace(e.currentTarget)
		...
		private function openStaticElementToolMenu():void
		{
			...
			this._staticElementToolMenu.addEventListener( StaticElementToolMenuEvent.BRING_FORWARD, this.onBringForwardStaticElementRequestHandler );
			this._staticElementToolMenu.addEventListener( StaticElementToolMenuEvent.SEND_BACKWARD, this.onSendBackwardStaticElementRequestHandler );
			this._staticElementToolMenu.addEventListener( StaticElementToolMenuEvent.CLOSE_REQUEST, this.onCloseStaticElementRequestHandler );
			this._staticElementToolMenu.addEventListener( StaticElementToolMenuEvent.DELETE_REQUEST, this.onDeleteStaticElementRequestHandler );
		...
		private function closeStaticElementToolMenu():void
		{
			if( this._staticElementToolMenu.parent )
			{
				...
				this._staticElementToolMenu.removeEventListener( StaticElementToolMenuEvent.BRING_FORWARD, this.onBringForwardStaticElementRequestHandler );
				this._staticElementToolMenu.removeEventListener( StaticElementToolMenuEvent.SEND_BACKWARD, this.onSendBackwardStaticElementRequestHandler );
				this._staticElementToolMenu.removeEventListener( StaticElementToolMenuEvent.CLOSE_REQUEST, this.onCloseStaticElementRequestHandler );
				this._staticElementToolMenu.removeEventListener( StaticElementToolMenuEvent.DELETE_REQUEST, this.onDeleteStaticElementRequestHandler );
		...
		private function onSendBackwardStaticElementRequestHandler( e:StaticElementToolMenuEvent ):void
		{
		...
		private function onCloseStaticElementRequestHandler( e:StaticElementToolMenuEvent ):void
		{
			this.closeStaticElementToolMenu();
		}

		private function onDeleteStaticElementRequestHandler( e:StaticElementToolMenuEvent ):void
		{
			var savedStaticElementView:StaticElementView = this._staticElementViews[ this._lastSelectedStaticElementIndex ];
